...
pontos DECIMAL(4,2),
fkTime INT,
FOREIGN KEY (fkTime) REFERENCES nbaTime(idNbaTime)
);
...
-- Boston Celtics
INSERT INTO jogador VALUES
	(null, "Jayson Tatum", "SF", 30.1, 4.6, 8.8, 0.7, 1.1, 2.9, 2.2, 2),
...
-- Sacramento Kings
    INSERT INTO jogador VALUES
	(null, "Keegan Murray", "PF", 4.6,	1.2,	0.8,	0.5,	0.8,	2.0,	12.2,	26.0, 22),
...
SELECT * FROM nbaTime;
SELECT * FROM usuario;
SELECT * FROM usuario JOIN nbaTime ON fkTime = idNbaTime;
SELECT 
u.nomeUsuario as 'Nome de usuario',
nba.nome as 'Time que torce' FROM usuario as u JOIN nbaTime as nba ON fkTime = idNbaTime;